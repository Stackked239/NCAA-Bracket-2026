...
export function IconBasketball({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <circle cx="12" cy="12" r="10" />
      <path d="M4.93 4.93c4.08 2.38 8.16 6.46 10.54 10.54" />
      <path d="M19.07 4.93c-4.08 2.38-8.16 6.46-10.54 10.54" />
...
export function IconCrown({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M11.562 3.266a.5.5 0 0 1 .876 0L15.39 8.87a1 1 0 0 0 1.516.294L20.266 6.5a.5.5 0 0 1 .734.475v8.525a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6.974a.5.5 0 0 1 .734-.474l3.36 2.664a1 1 0 0 0 1.516-.294z" />
      <path d="M21 17.5H3" />
      <path d="M5 21h14" />
    </svg>
  );
...
export function IconCrystalBall({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <circle cx="12" cy="11" r="8" />
      <path d="M7 20.7a1 1 0 0 0 1 .3h8a1 1 0 0 0 1-.3" />
      <path d="M5 19h14" />
    </svg>
  );
}
